...
It uses the C++ library [CDT](https://github.com/artem-ogre/CDT). A copy of 
the 'CDT' license is provided in the file **LICENSE.note**, and the source 
code of this library can be found in the **src** folder.
